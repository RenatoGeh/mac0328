...
setlocal fen
silent! normal! zE
let s:l = 94 - ((55 * winheight(0) + 29) / 58)
...
setlocal fen
silent! normal! zE
let s:l = 71 - ((12 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
setlocal fen
silent! normal! zE
let s:l = 118 - ((24 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
setlocal fen
silent! normal! zE
let s:l = 87 - ((57 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
...
setlocal fen
silent! normal! zE
let s:l = 25 - ((9 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
setlocal fen
silent! normal! zE
let s:l = 167 - ((54 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
